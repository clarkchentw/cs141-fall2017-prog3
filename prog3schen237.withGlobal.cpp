...
void updateLast3Guess(int newGuess){
...
void recordToDatabase(bool userInput){
    if (numOfMove < 5){
        return;
    }
    int binaryNum = last3Guess[0]*100 + last3Guess[1]*10 + last3Guess[2];
...
void mainProcess(bool& validUserInput){
    // numOfMove + 1 when user input is valid
    ++numOfMove;
    recordToDatabase(validUserInput);
    updateLast3Guess(validUserInput);
